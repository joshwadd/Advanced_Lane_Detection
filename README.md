...
- **Weighted moving average ** : Currently every model fit is weighted equally when making a moving average approximation. This is clearly not desirable as some line model fits will be made under move certain data then other. This should be taken into consideration when making an av
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjg2ODU0ODkyXX0=
-->