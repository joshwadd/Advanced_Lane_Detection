...
The distortions can be quantified and then removed by comparing multiple distorted images of a simple object with known spatial properties. The
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTQ0MzU4NDM2XX0=
-->