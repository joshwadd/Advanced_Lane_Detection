...
From the first window, a sliding window placed along the centres of each line following up to the top of the frame. The full implementation of this is found in the 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NDA4MDQzODNdfQ==
-->