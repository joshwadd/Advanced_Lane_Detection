...
- **Weighted moving average ** : Currently every model fit is weighted equally when making a moving average approximation. This is c
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NjQ0NDg1MThdfQ==
-->