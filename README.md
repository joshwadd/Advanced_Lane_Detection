...
This is done by breaking the edge detecting process into two tracks, the first filters the image by thresholding colours in HSL space.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNjE4OTkyMTRdfQ==
-->