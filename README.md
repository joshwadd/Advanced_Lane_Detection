...
Many aspects of the pipeline (particularly the lane edge detection, colour and gradient parameters) had to be hand tuned to a small set of idealised images and would n
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMjM0NDczNjddfQ==
-->