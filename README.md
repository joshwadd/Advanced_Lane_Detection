...
Two instances of the `Line` class are initialised to contain the left and right lane lines within the `LaneDetection` class. With the 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMzQwMjIzMzZdfQ==
-->