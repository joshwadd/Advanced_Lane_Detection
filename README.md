...
1. **Camera calibration** :  Use of imaging hardware in practice often produces distortions in the obtained images that can change the 
2. **Edge detection** :
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg5MTQwMzM1MF19
-->