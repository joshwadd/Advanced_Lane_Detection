...
- **Weighted moving average ** : Currently every model fit is weighted equally when making a moving average approximation. This is clearing
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIyMDMwMDEzMF19
-->