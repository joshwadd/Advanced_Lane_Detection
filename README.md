...
4. **Line detection** : With an overhead perspective of the binary image of lane pixels, the pixels associated with the left and right lane lines are detected. This can be done initially 
5.  **Fit Polynomial** :
6. **Measuring lane parameters** :


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc4OTkyMzE1MV19
-->