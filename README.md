...
Two instances of the `Line` class are initialised for the left and right lane lines within the `LaneDetection` class. With the 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MjQ5MjI4MTZdfQ==
-->