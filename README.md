...
To identify and fit polynomials curving lane lines it is useful to transform the perspective of the front facing camera to an overhead or 'birdseye' view of the lane.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjcxOTEzMDI3XX0=
-->