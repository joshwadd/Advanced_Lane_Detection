...
This function is used on every calibration image making a list of corner coordinates for each image and also a list of the coordina 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4Njk4MzAyMDNdfQ==
-->