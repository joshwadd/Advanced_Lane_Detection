...
If the lane lines have been detected in previous video frames, searching the image blindly is an unnessary computational expense. It is instead more 

![](https://github.com/joshwadd/Advanced_Lane_Detection/blob/master/output_images/regionsearch.png?raw=true)

<!--stackedit_data:
eyJoaXN0b3J5IjpbNTc3NDczMTQwXX0=
-->