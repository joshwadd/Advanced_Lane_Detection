...
1. **Camera calibration** :  Use of imaging hardware in practice often produces distortions in the obtained images that can change the perceived location and size of objects in the image.
2. **Edge detection** :
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM4NjUzNjYyNl19
-->