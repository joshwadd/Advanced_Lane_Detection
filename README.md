...
[![png](https://github.com/joshwadd/Advanced_Lane_Detection/blob/master/output_images/thumbnail_1.png?raw=true)](https://www.youtube.com/watch?v=OrnYWgps33c&feature=youtu.be)
...
- **Weighted moving average ** : Currently every model fit is weighted equally when making a moving average approximation. This is clearly not desirable as some line model fits will be made under move certain data then other. This should be taken into consideration when making an average over previous fra
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExODY2OTcyNTBdfQ==
-->