...
3. **Perspective Transform** : The perspective of the binary image is transformed to give an over head 'birdseye' view of the lane lines. This makes it easier to detect 
5. **Line detection** :
6. **Measuring lane parameters** :


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA2MTUxOTc3N119
-->