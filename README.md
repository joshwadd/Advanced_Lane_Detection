...
In order to fit these windows to the correct positions in the image, we first take a histogram of the lower half of the binary image mask. This should give two peaks
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MjAzNDU4NDBdfQ==
-->