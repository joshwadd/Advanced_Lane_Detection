...
The distortions can be quantified and then removed by comparing multiple distorted images of a simple object with known spatial properties. The standard 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMzMjk0MDgzM119
-->