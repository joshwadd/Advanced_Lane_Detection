...
- **Weighted moving average ** : Currently every model fit is weighted equally when making a moving average approximation. This is clearly not 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMzMDMzNTkwOF19
-->