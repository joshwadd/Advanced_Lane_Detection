...
Many aspects of the pipeline (particularly the lane edge detection, colour and gradient parameters) had to be hand tuned to a small set of idealised images and would not be expected to be robust to many sinarios incounter by the vechin
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgwMTU2ODAwXX0=
-->