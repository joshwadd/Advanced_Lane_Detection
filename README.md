...
| File                                | Description                                                                        |
| ----------------------------------- | ---------------------------------------------------------------------------------- |
| `Code/calibration.py`      | `CameraCalibration` class used to remove any distortions in the image assoaited with the imaging hardware . |
...
| `Code/perspective.py`   | `PerspectiveTransformation` class to implement a perspective transformation to an overhead lane view. |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MDc1OTE0MTZdfQ==
-->