...
The processing pipeline used for the lane detection and identification of lane properties is composed of the following key steps. These are further outlined the 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQwNjYxOTI2XX0=
-->