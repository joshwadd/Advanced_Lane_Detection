...
OpenCV has a set of routines for the quantification and then removal of camera distortion. First the coordinates of the chess board corners
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAzMzAzOTIzMF19
-->