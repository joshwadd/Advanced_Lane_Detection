...
To do this we must first blindly search the image using a sliding window method to find the left and right line pixels. For video data streams


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMxNTY4ODAwXX0=
-->